...
$toemails[] = array(
				'email' => 'cristianjuradov@gmail.com', // Your Email Address
				'name' => 'Trujillo Gutierrez' // Your Name
			);

$toemails[] = array(
				'email' => 'ventastorresdelbosque@trujillogutierrez.com.co', // Your Email Address
				'name' => 'Trujillo Gutierrez' // Your Name
			);

$toemails[] = array(
				'email' => 'mariafegallego@gmail.com', // Your Email Address
				'name' => 'Trujillo Gutierrez' // Your Name
			);
...
$fromemail = array(
				'email' => 'ventas@trujillogutierrez.com.co', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'Trujillo Gutierrez' // Company Name
			);
...
$recaptcha_secret = '6LfGmrQUAAAAAGBOyNsXLGjJNKx2H5uZEKpAOxAx'; // Your reCaptcha Secret
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	...
	$message = array(
		'success'			=> 'Hemos <strong>recibido</strong> tu mensaje y tendrás respuesta muy pronto !',
		'error'				=> 'Hubo un <strong>error</strong> con tu mensaje. Intenta de nuevo.',
	...
	$html_title	= !empty( $submits['html_title'] ) ? $submits['html_title'] : 'Formulario Torres del Bosque';
	...
	$referrer = $_SERVER['HTTP_REFERER'] ? '<br><br><br>Este formulario ha llegado desde: ' . $_SERVER['HTTP_REFERER'] : '';
